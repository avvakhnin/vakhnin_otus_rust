...
/// Примеры вызова из консоли:
/// printf "switch_on_" | nc 127.0.0.1 9876
/// printf "switch_off" | nc 127.0.0.1 9876
/// printf "get_status" | nc 127.0.0.1 9876
/// printf "get_power_" | nc 127.0.0.1 9876
fn main() {
    env_logger::init();
